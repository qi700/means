            ...
            if len(contents)>0:
                ...
                if len(test_docs) >3:
                    ...
                    for text in test_docs:
                        ...
                        weight.append(ecludDist(layer,title_v))
                    ...
                    kMeans(dataset=x_texts, dist=ecludDist, center=initial_center, k=k,test_docs=test_docs,weight)
                    '''
                    f:F1值  p：查准率  R：召回率
                    '''
